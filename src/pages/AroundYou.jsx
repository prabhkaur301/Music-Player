...
const AroundYou = () => {
    ...
    useEffect(() => {
        axios.get('https://geo.ipify.org/api/v2/country?apiKey=at_LhNHg773hcTmRJzBgQYIXvZFoy9LN')
    ...
    return (
        <div className="flex flex-col">
            ...
            <span className="text-white text-3xl font-bold mt-4 mb-10"> ({location?.region || 'India'})</span> </h2>
